...
#if 0
#define PARALLAX_GPU_MEM_OFFS   (512*1024*1024)
#define PARALLAX_DMA_MEM_OFFS   (392*1024*1024) 
#define PARALLAX_CSI_MEM_OFFS   (352*1024*1024) /* 2 DMA size buffers */ 
#define PARALLAX_VPU_MEM_OFFS   (340*1024*1024) 
#define PARALLAX_HVPU_MEM_OFFS  (332*1024*1024) 
#define PARALLAX_DVPU_MEM_OFFS  (328*1024*1024) 
#define PARALLAX_JVPU_MEM_OFFS  (312*1024*1024) 
#endif

#define PARALLAX_GPU_MEM_OFFS   (512*1024*1024)
#define PARALLAX_DMA_MEM_OFFS   (352*1024*1024) 
#define PARALLAX_CSI_MEM_OFFS   (312*1024*1024) /* 2 DMA size buffers */ 
#define PARALLAX_VPU_MEM_OFFS   (300*1024*1024) 
#define PARALLAX_HVPU_MEM_OFFS  (292*1024*1024) 
#define PARALLAX_DVPU_MEM_OFFS  (288*1024*1024) 
#define PARALLAX_JVPU_MEM_OFFS  (272*1024*1024) 
...
#define DMA_FRAME_BUFFER_NUM 4
#define M3_VPU_BUFFER_IC_ID 3
