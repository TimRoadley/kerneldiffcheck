...
//	SD_PINS(2, USDHC_PAD_CTRL_22KPU_40OHM_50MHZ),
 //      MX6PAD(SD1_CLK__OSC32K_32K_OUT), /* wl1271 clock */
	...
	/* UART3 for wl1271 */
//	MX6PAD(EIM_D24__UART3_TXD), // CSI0 RESET in Parallax
...
#endif
	/* ENET */
#ifdef MICREL_USE_MDIO
	MX6PAD(ENET_MDIO__ENET_MDIO),
	MX6PAD(ENET_MDC__ENET_MDC),
#else
	MX6PAD(ENET_MDIO__GPIO_1_22), /* Parallax: configure as GPIO for bitbang*/
	MX6PAD(ENET_MDC__GPIO_1_31),
#endif
...
//	MX6PAD(GPIO_16__ENET_1588_EVENT2_IN),		/* Micrel RGMII Phy Interrupt */
//	MX6PAD(GPIO_16__GPIO_7_11),		/* Micrel RGMII Phy Interrupt */
	MX6PAD(EIM_D31__GPIO_3_31),		/* Micrel RGMII Phy Interrupt */
//	MX6PAD(GPIO_2__GPIO_1_2),		/*  RESET */
...
//	MX6PAD(GPIO_19__GPIO_4_5),	/* J14 - Volume Down */
	...
	MX6PAD(EIM_DA8__GPIO_3_8),		/* CSI1  reset */
	MX6PAD(EIM_DA10__GPIO_3_10),		/* CSI1  power down */
        MX6PAD(EIM_DA11__IPU1_CSI1_HSYNC),      /* GPIO3[11] */
        MX6PAD(EIM_DA12__IPU1_CSI1_VSYNC),      /* GPIO3[12] */
        MX6PAD(EIM_A16__IPU1_CSI1_PIXCLK),      /* GPIO2 */
#endif
...
//	MX6PAD(EIM_D28__I2C1_SDA),	/* GPIO3[28] */
	...
	/* I2C2 Parallel Camera 0 */
	MX6PAD(EIM_EB2__I2C2_SCL),	/* GPIO4[12] */
	MX6PAD(EIM_D16__I2C2_SDA),	/* GPIO4[13] */

	/* I2C3 Parallel Camera 1 */
	MX6PAD(EIM_D17__I2C3_SCL),	/* GPIO1[5] - J7 - Display card */
	MX6PAD(EIM_D18__I2C3_SDA),	/* GPIO7[11] - J15 - RGB connector */
	...
	/* PWM4 GREEN */
	MX6PAD(SD1_DAT1__PWM3_PWMO),
//	MX6PAD(SD1_CMD__PWM4_PWMO),		/* GPIO1[18] */

	/* LED power enable */
	MX6PAD(GPIO_9__GPIO_1_9),		/* 5V enable for Parallax LED */

	/* RTC ISL1208 irq*/
//	MX6PAD(NANDF_CLE__GPIO_6_7),
	// NAND flash
	MX6PAD(NANDF_CLE__RAWNAND_CLE),
	MX6PAD(NANDF_ALE__RAWNAND_ALE),
	MX6PAD(NANDF_RB0__RAWNAND_READY0),
	MX6PAD(NANDF_WP_B__RAWNAND_RESETN),
	MX6PAD(NANDF_D0__RAWNAND_D0),
	MX6PAD(NANDF_D1__RAWNAND_D1),
	MX6PAD(NANDF_D2__RAWNAND_D2),
	MX6PAD(NANDF_D3__RAWNAND_D3),
	MX6PAD(NANDF_D4__RAWNAND_D4),
	MX6PAD(NANDF_D5__RAWNAND_D5),
	MX6PAD(NANDF_D6__RAWNAND_D6),
	MX6PAD(NANDF_D7__RAWNAND_D7),
	MX6PAD(NANDF_CS0__RAWNAND_CE0N),
	MX6PAD(SD4_CLK__RAWNAND_WRN),
	MX6PAD(SD4_CMD__RAWNAND_RDN),
	...
	/* UART2 for debug */
	MX6PAD(SD3_DAT5__UART2_TXD),
	MX6PAD(SD3_DAT4__UART2_RXD),
...
#if defined(CONFIG_MXC_CAMERA_OV5642) || defined(CONFIG_MXC_CAMERA_OV5642_MODULE) || defined(CONFIG_MXC_CAMERA_OV5653) || defined(CONFIG_MXC_CAMERA_OV5653_MODULE) 
...
//	MX6PAD(CSI0_DATA_EN__IPU1_CSI0_DATA_EN),
	...
	MX6PAD(EIM_D24__GPIO_3_24),		/* CSI0 RESET */
	MX6PAD(CSI0_DATA_EN__GPIO_5_20),	/* CSI0 power down */
