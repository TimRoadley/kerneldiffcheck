...
#define VPU_MEM_DESCR_ALLOC	0x01	/* Regular allocation through kernel facility */
#define VPU_MEM_DESCR_DMAMAP	0x02	/* Custom DMA map allocations (phys + ioremap)*/
#define VPU_MEM_DESCR_VPU_DMA   0x04    /* Custom DMA map allocations (phys + ioremap)*/
#define VPU_MEM_DESCR_BUSY      0x10    /*Custom indicator */
#define VPU_MEM_DESCR_USER_BUSY 0x100   /* User allocated flag */
...
struct vpu_mem_desc {
	...
	u32 flags;		/* Flags to indicate the nature of allocations */
};
...
#define VPU_IOC_DMAMEM_FREE	_IO(VPU_IOC_MAGIC, 16)
#define VPU_IOC_RESET_WARM_REBOOT _IO(VPU_IOC_MAGIC, 17)
