...
static struct reg_value ov5640_init_setting_30fps_VGA[] = {
	...
	{0x5000, 0xa7, 0, 0}, {0x5001, 0xa3, 0, 0}, {0x5180, 0xff, 0, 0},	//0x5000: 0xa7, 0x5001: 0xa3
...
static struct reg_value ov5640_init_setting_15fps_LPR[] = {
	{0x3008, 0x42, 0, 0},
	...
	{0x380b, 0x98, 0, 0}, {0x380c, 0x0c, 0, 0}, {0x380d, 0x80, 0, 0},
	{0x380e, 0x0f, 0, 0}, {0x380f, 0xa0, 0, 0}, {0x3810, 0x00, 0, 0},
...
static struct ov5640_mode_info ov5640_mode_info_data[2][ov5640_mode_MAX + 1] = {
	{
		...
		ov5640_init_setting_15fps_LPR,
		ARRAY_SIZE(ov5640_init_setting_15fps_LPR)},
//		{ov5640_mode_QSXGA_2592_1944, SCALING, 2592, 1944,
...
//	printk(KERN_INFO "OV5640 MIPI: CHange mode direct: w: %d, h: %d, fr: %d\n", 
//			ov5640_data.pix.width,ov5640_data.pix.height, frame_rate);
	/* Write capture setting */
	retval = ov5640_download_firmware(pModeSetting, ArySize);
	if (retval < 0)
		goto err;
			...
			const struct i2c_device_id *id)
{
	...
	printk(KERN_INFO "OV5640 MIPI: Camera OV5640 MIPI found\n");
	return retval;
...
static __init int ov5640_init(void)
{
	...
	printk(KERN_INFO "OV5640 MIPI: Camera OV5640 MIPI Initialized\n");
	return err;
}
