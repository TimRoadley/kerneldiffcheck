...
#define OV5642_MAX_EXP_LINES 1984
...
enum ov5642_mode {
	...
	ov5642_mode_800_600 = 9,
	ov5642_mode_1600_1200 = 10,
	ov5642_mode_160_120 = 11,
	ov5642_mode_MAX = 11
};
...
static struct reg_value ov5642_initial_setting[] = {
	...
	{0x5686, 0x03, 0, 0},{0x5687, 0xbc, 0, 0},
...
static struct reg_value ov5642_setting_15fps_QCIF_176_144[] = {
	...
	{0x3805, 0x00, 0, 0},  
	{0x3806, 0x03, 0, 0}, {0x3807, 0xc0, 0, 0}, 
	{0x3a00, 0x78, 0, 0}, {0x3a1a, 0x05, 0, 0},
...
static struct reg_value ov5642_setting_15fps_QSXGA_2592_1944[] = {
	...
	{0x5001, 0xff, 0, 0}, {0x589b, 0x00, 0, 0},
	{INTERRUPT_FUNC_AEC_POLYGON, 0, 0, 0},	
...
static struct reg_value ov5642_setting_30fps_800_600[] = {
	...
	{0x3705, 0xda, 0, 0}, {0x370a, 0x80, 0, 0}, {0x3801, 0x95, 0, 0},
	{0x3803, 0x0e, 0, 0}, {0x3804, 0x0a, 0, 0}, {0x3805, 0x20, 0, 0},
	{0x3806, 0x07, 0, 0}, {0x3807, 0x98, 0, 0}, {0x3808, 0x03, 0, 0},
...
static struct reg_value ov5642_setting_30fps_1600_1200[] = {
	{0x3503, 0x07, 0, 0}, {0x3000, 0x00, 0, 0}, {0x3001, 0x00, 0, 0},
	{0x3002, 0x00, 0, 0}, {0x3003, 0x00, 0, 0}, {0x3004, 0xff, 0, 0},
	{0x3005, 0xff, 0, 0}, {0x3006, 0xff, 0, 0}, {0x3007, 0x3f, 0, 0},
	{0x3011, 0x08, 0, 0}, {0x3010, 0x10, 0, 0}, {0x3818, 0xc0, 0, 0},
	...
	{0x3705, 0xda, 0, 0}, {0x370a, 0x80, 0, 0}, {0x3801, 0x95, 0, 0},
	{0x3803, 0x0e, 0, 0}, {0x3804, 0x0a, 0, 0}, {0x3805, 0x20, 0, 0},
	{0x3806, 0x07, 0, 0}, {0x3807, 0x98, 0, 0}, {0x3808, 0x06, 0, 0},
	{0x3809, 0x40, 0, 0}, {0x380a, 0x04, 0, 0}, {0x380b, 0xB0, 0, 0},
	{0x380c, 0x0c, 0, 0}, {0x380d, 0x80, 0, 0}, {0x380e, 0x07, 0, 0},
	{0x380f, 0xd0, 0, 0}, {0x3810, 0xc2, 0, 0}, {0x3815, 0x44, 0, 0},
	{0x3824, 0x11, 0, 0}, {0x3825, 0xac, 0, 0}, {0x3827, 0x0c, 0, 0},
	{0x3a00, 0x78, 0, 0}, {0x3a0d, 0x10, 0, 0}, {0x3a0e, 0x0d, 0, 0},
...
static struct reg_value ov5642_setting_QSXGA_2_VGA[] = {
	...
	{0x3a0d, 0x04, 0, 0}, {0x3a0e, 0x03, 0, 0}, 
	{INTERRUPT_FUNC_AEC_POLYGON, 0, 0, 0},			
...
static struct reg_value ov5642_setting_30fps_XGA_1024_768[] = {
	...
	{0x3705, 0xda, 0, 0}, {0x370a, 0x80, 0, 0}, {0x3801, 0x95, 0, 0},
	{0x3803, 0x0e, 0, 0}, {0x3804, 0x0a, 0, 0}, {0x3805, 0x20, 0, 0},
	{0x3806, 0x07, 0, 0}, {0x3807, 0x98, 0, 0}, {0x3808, 0x04, 0, 0},
...
static struct reg_value ov5642_setting_30fps_QVGA_320_240[] = {
	...
	{0x3705, 0xda, 0, 0}, {0x370a, 0x80, 0, 0}, {0x3801, 0x95, 0, 0},
	{0x3803, 0x0e, 0, 0}, {0x3804, 0x0a, 0, 0}, {0x3805, 0x20, 0, 0},
	{0x3806, 0x07, 0, 0}, {0x3807, 0x98, 0, 0}, {0x3808, 0x01, 0, 0},
...
static struct reg_value ov5642_setting_30fps_NTSC_720_480[] = {
	...
	{0x3804, 0x05, 0, 0}, {0x3805, 0x00, 0, 0}, 
	{0x3806, 0x03, 0, 0}, {0x3807, 0x58, 0, 0},
	{0x3a00, 0x78, 0, 0},
	{INTERRUPT_FUNC_AEC_POLYGON, 0, 0, 0},			
	{0x3a1a, 0x05, 0, 0}, {0x3a13, 0x30, 0, 0}, {0x3a18, 0x00, 0, 0},
	{0x3a19, 0x7c, 0, 0}, {0x3a08, 0x12, 0, 0}, {0x3a09, 0xc0, 0, 0},
...
static struct reg_value ov5642_setting_30fps_PAL_720_576[] = {
	...
	{0x3801, 0x80, 0, 0}, {0x3621, 0xc7, 0, 0}, {0x3801, 0x50, 0, 0},
	{0x3803, 0x08, 0, 0}, {0x3827, 0x3c, 0, 0}, {0x3810, 0x80, 0, 0},
	{0x3804, 0x04, 0, 0}, {0x3805, 0xb0, 0, 0}, 
	{0x3806, 0x03, 0, 0}, {0x3807, 0x58, 0, 0},
	{0x3a00, 0x78, 0, 0},
	{INTERRUPT_FUNC_AEC_POLYGON, 0, 0, 0},			
	{0x3a1a, 0x05, 0, 0}, {0x3a13, 0x30, 0, 0}, {0x3a18, 0x00, 0, 0},
...
static struct reg_value ov5642_setting_15fps_720P_1280_720[] = {
	...
	{0x3809, 0x20, 0, 0}, {0x380a, 0x07, 0, 0}, {0x380b, 0x98, 0, 0},
	{0x380c, 0x0c, 0, 0}, {0x380d, 0x80, 0, 0}, {0x380e, 0x07, 0, 0},
	{0x380f, 0xd0, 0, 0}, {0x501f, 0x00, 0, 0},
	{INTERRUPT_FUNC_AEC_POLYGON, 0, 0, 0},			
	...
	{0x5001, 0x7f, 0, 0}, {0x589b, 0x06, 0, 0},
...
static struct reg_value ov5642_setting_30fps_160_120[] = {
    {0x3503, 0x00, 0, 0}, {0x3000, 0x00, 0, 0}, {0x3001, 0x00, 0, 0},
    {0x3002, 0x00, 0, 0}, {0x3003, 0x00, 0, 0}, {0x3004, 0xff, 0, 0},
    {0x3005, 0xff, 0, 0}, {0x3006, 0xff, 0, 0}, {0x3007, 0x3f, 0, 0},
    {0x3011, 0x08, 0, 0}, {0x3010, 0x10, 0, 0}, {0x3818, 0xc0, 0, 0},
    ...
    {0x3705, 0xda, 0, 0}, {0x370a, 0x80, 0, 0}, {0x3801, 0x95, 0, 0},
    {0x3803, 0x0e, 0, 0}, {0x3804, 0x0a, 0, 0}, {0x3805, 0x20, 0, 0},
    {0x3806, 0x07, 0, 0}, {0x3807, 0x98, 0, 0}, {0x3808, 0x00, 0, 0},
    {0x3809, 0xA0, 0, 0}, {0x380a, 0x00, 0, 0}, {0x380b, 0x78, 0, 0},
    {0x380c, 0x0c, 0, 0}, {0x380d, 0x80, 0, 0}, {0x380e, 0x07, 0, 0},
    {0x380f, 0xd0, 0, 0}, {0x3810, 0xc2, 0, 0}, {0x3815, 0x44, 0, 0},
    {0x3824, 0x11, 0, 0}, {0x3825, 0xac, 0, 0}, {0x3827, 0x0c, 0, 0},
    {0x3a00, 0x78, 0, 0}, {0x3a0d, 0x10, 0, 0}, {0x3a0e, 0x0d, 0, 0},
...
static struct ov5642_mode_info ov5642_mode_info_data[2][ov5642_mode_MAX + 1] = {
	{
		...
		{ov5642_mode_800_600, 800, 600, ov5642_setting_30fps_800_600,
                ARRAY_SIZE(ov5642_setting_30fps_800_600)},
		{ov5642_mode_1600_1200, 1600, 1200,
		ov5642_setting_30fps_1600_1200,
		ARRAY_SIZE(ov5642_setting_30fps_1600_1200)},
		{ov5642_mode_160_120, 160, 120,
		ov5642_setting_30fps_160_120,
		ARRAY_SIZE(ov5642_setting_30fps_160_120)},
	},
	{
		{ov5642_mode_VGA_640_480,    640,  480,
		...
		{ov5642_mode_800_600, 800, 600,
		ov5642_setting_30fps_800_600,
		ARRAY_SIZE(ov5642_setting_30fps_800_600)},
		{ov5642_mode_1600_1200, 1600, 1200,
		ov5642_setting_30fps_1600_1200,
		ARRAY_SIZE(ov5642_setting_30fps_1600_1200)},
...
static void ov5642_set_aec_poly(void);
...
static s32 ov5642_write_reg(u16 reg, u8 val)
{
	...
	if ((ret = i2c_master_send(ov5642_data.i2c_client, au8Buf, 3)) < 0) {
...
static enum ov5642_frame_rate get_frame_rate_id(int fps)
{
	if (fps == 15)
...
static int ov5642_write_snapshot_para(enum ov5642_frame_rate frame_rate,
		enum ov5642_mode mode, struct v4l2_framepos *pfpos);
static int ov5642_change_mode(enum ov5642_frame_rate new_frame_rate,
		...
		enum ov5642_mode orig_mode, struct v4l2_framepos *pfpos)
{
	...
	ov5642_data.frame_rate = new_frame_rate;
	if ((new_frame_rate == old_frame_rate) &&
		...
		retval = ov5642_write_snapshot_para(new_frame_rate, new_mode, pfpos);
		goto err;
	}
...
/* -=-=-=-=-=-==-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-==
* Set start for OV5642 camera
*/
static inline void ov5642_set_frame_start (int x, int y, int offs_x, int offs_y) {
        int X = x + offs_x;        /* offset to valid pixel region */
        int Y = y + offs_y;
        u8 RegVal = 0;

 
        ov5642_read_reg(0x3800, &RegVal);
        printk(KERN_INFO "OV5642: 0x3800: %X\n", RegVal);
        ov5642_read_reg(0x3801, &RegVal);
        printk(KERN_INFO "OV5642: 0x3801: %X\n", RegVal);
        ov5642_read_reg(0x3802, &RegVal);
        printk(KERN_INFO "OV5642: 0x3802: %X\n", RegVal);
        ov5642_read_reg(0x3803, &RegVal);
        printk(KERN_INFO "OV5642: 0x3803: %X\n", RegVal);


        ov5642_read_reg(0x3824, &RegVal);
        printk(KERN_INFO "OV5642: 0x3824: %X\n", RegVal);
        ov5642_read_reg(0x3825, &RegVal);
        printk(KERN_INFO "OV5642: 0x3825: %X\n", RegVal);
        ov5642_read_reg(0x3826, &RegVal);
        printk(KERN_INFO "OV5642: 0x3826: %X\n", RegVal);
        ov5642_read_reg(0x3827, &RegVal);
        printk(KERN_INFO "OV5642: 0x3827: %X\n", RegVal);


        printk(KERN_INFO "Setting Frame start: X: %X, Y: %X\n", X, Y); 
        ov5642_write_reg(0x3800, (unsigned char)((X>>8)&0x0f));/* sensor x start point(h)*/
        ov5642_write_reg(0x3801, (unsigned char)(X&0xff));         /* sensor x start point(l)*/
        ov5642_write_reg(0x3802, (unsigned char)((Y>>8)&0x0f));    /* sensor y start point(h)*/
        ov5642_write_reg(0x3803, (unsigned char)(Y&0xff));         /* sensor y start point(l) */
#if 0
        ov5642_write_reg(0x3824, (unsigned char)((X>>8)&0x0f));/* sensor x start point(h)*/
        ov5642_write_reg(0x3825, (unsigned char)(X&0xff));         /* sensor x start point(l)*/
        ov5642_write_reg(0x3826, (unsigned char)((Y>>8)&0x0f));    /* sensor y start point(h)*/
        ov5642_write_reg(0x3827, (unsigned char)(Y&0xff));         /* sensor y start point(l) */
#endif
}

/* -=-=-=-=-=-==-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-==
* Set input size for OV5642
*/
static inline void ov5642_set_frame_input_size (int x, int y)
{
        u8 RegVal = 0;
        ov5642_read_reg(0x3804, &RegVal);
        printk(KERN_INFO "OV5642: 0x3804: %X\n", RegVal);
        ov5642_read_reg(0x3805, &RegVal);
        printk(KERN_INFO "OV5642: 0x3805: %X\n", RegVal);
        ov5642_read_reg(0x3806, &RegVal);
        printk(KERN_INFO "OV5642: 0x3806: %X\n", RegVal);
        ov5642_read_reg(0x3807, &RegVal);
        printk(KERN_INFO "OV5642: 0x3807: %X\n", RegVal);
        /* set Sensor output size */
        printk(KERN_INFO "Setting Frame Size: SW: %X, SH: %X\n", x, y); 
        ov5642_write_reg(0x3804, (unsigned char)((x>>8)&0x0f));    /* sensor x output size(h)*/
        ov5642_write_reg(0x3805, (unsigned char)(x&0xff));         /* sensor x output size(l)*/
        ov5642_write_reg(0x3806, (unsigned char)((y>>8)&0x0f));    /* sensor y output size(h)*/
        ov5642_write_reg(0x3807, (unsigned char)(y&0xff));         /* sensor y output size(l)*/
       ...
       enum ov5642_mode mode, struct v4l2_framepos *pfpos)
{
	...
	msleep(500);
        ...
        if(sw > 2592) sw = 2592;
        if(sh > 1944) sw = 1944;
        if(mode == ov5642_mode_VGA_640_480) {
            sw = 0x500;
            sh = 0x3c0;
            off_x = 0x50;
            off_y = 0x08;
...
//        printk(KERN_INFO "++++++OV5642: X: %d, Y: %d, SW: %d, SH: %d\n", sx, sy, sw, sh);
//	ov5642_set_frame_start(sx, sy, off_x, off_y);
//	ov5642_set_frame_input_size(sw, sh);
	return ret;
}


/* -=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-= 
* This sets manual exposure in lines for OV5642 5MP sensor
*/
static void ov5642_set_exposure(unsigned short exposure_in_lines)
{
        unsigned short explines;
        unsigned short max_explines = OV5642_MAX_EXP_LINES;

	explines = exposure_in_lines;
	if (explines > max_explines) {
		max_explines = OV5642_MAX_EXP_LINES + 
				OV5642_MAX_EXP_LINES*((explines-1)/OV5642_MAX_EXP_LINES);
    }

    // for some reason, if explines is close to max_explines, we get a black frame. So just jump it:
    if ( (max_explines - explines) < 3 ) {
    	explines = max_explines;
    }

    //printk(KERN_INFO "OV5642_0: Set Exposure lines: %d/%d, max: %d\n", exposure_in_lines, explines, max_explines);
	/* need to set the VSIZE in two places */
    ov5642_write_reg(0x350D, ((max_explines) & 0x00FF));
    ov5642_write_reg(0x350C, (((max_explines) >> 8) & 0x00FF));
	ov5642_write_reg(0x380F, ((max_explines) & 0x00FF));
	ov5642_write_reg(0x380E, (((max_explines) >> 8) & 0x00FF)); 

    ov5642_write_reg(0x3502, ((explines << 4) & 0x00F0));
    ov5642_write_reg(0x3501, ((explines >> 4) & 0x00FF));
    ov5642_write_reg(0x3500, ((explines >> 12) & 0x000F));
}

static unsigned int ov5642_get_exposure(void)
{
	unsigned int exp;
	unsigned int vts = 0;
	unsigned char regval;
  
	ov5642_read_reg(0x3500, &regval);	/* exposure[19:16] */
	exp = (regval & 0x0F);
	ov5642_read_reg(0x3501, &regval);	/* exposure[15:8] */
	exp = (exp<<8) | regval;
	ov5642_read_reg(0x3502, &regval);	/* exposure[7:0] */
	exp = (exp<<4) | ((regval>>4) & 0x0F);
	// also print out the VTS so we can try to calculate how many frames of exposure this is:
	ov5642_read_reg(0x350c,&regval);
	vts = regval<<8;
	ov5642_read_reg(0x350d,&regval);
	vts = vts | regval;
//	printk("[Got exposure: %d]\n", exp);
	return exp;
}

static void ov5642_set_gain(unsigned int gain)
{
	unsigned char gain_bits;
	
	gain_bits = gain - 1;
	ov5642_write_reg(0x3509, (gain_bits<<4)&0xF0);
	ov5642_write_reg(0x350b, (gain_bits<<4)&0xF0);
	ov5642_write_reg(0x3508, (gain_bits>>4)&0x01);
	ov5642_write_reg(0x350a, (gain_bits>>4)&0x01);

}

static unsigned int ov5642_get_gain(void)
{
	...
	// read the high bit:
	ov5642_read_reg(0x350a, &regval1);
	// read the low bits:
	ov5642_read_reg(0x350b, &regval2);
	// put them together in this weird way
	gain = (16 + (regval2 & 0x0F)) * (( (regval2>>4) | ((regval1 & 0x01)<<4))+1); 

	return gain;
}

/* 0 - turn auto-exposure OFF, 1 - turn AE ON*/
static void ov5642_set_autoexposure(int on) 
{ 
    unsigned char val;
    if(on){
		/* Auto-exposure */
        ov5642_read_reg(0x3503, &val);
        val &= 0xFE;
        ov5642_write_reg(0x3503, val);
        ov5642_write_reg(0x3a00, 0x7C);
    }else{
    	/* Manual exposure */
	ov5642_read_reg(0x3503, &val);
	val |= 0x01;
        ov5642_write_reg(0x3503, val);
        ov5642_write_reg(0x3a00, 0x08); 
    }
}

/* Returns: 0 - auto-exposure is OFF, 1 - auto-exposure is ON.*/
static int ov5642_get_autoexposure(void)
{
   	char result;
	ov5642_read_reg(0x3503, &result);
   	return (result & 0x01)?0:1;
}

/* 0 - turn auto-gain OFF, 1 - turn AG ON*/
static void ov5642_set_autogain(int on) 
{ 
	unsigned char val;
    if(on){
		/* Auto-exposure */
...
static int ov5642_get_autogain(void)
{
   	char result;
	ov5642_read_reg(0x3503, &result);
...
static void ov5642_set_aec_poly(void)
{
    ...
    if((ov5642_data.pix.width > 1024) && (ov5642_data.pix.height > 768)) {
    ...
    // X start
    ov5642_write_reg(0x5681, (ulx & 0xFF));
    ov5642_write_reg(0x5680, (ulx >> 8) & 0x0F);
    // Y start
    ov5642_write_reg(0x5685, (uly & 0xFF));
    ov5642_write_reg(0x5684, (uly >> 8) & 0x07);
    // X end
    ov5642_write_reg(0x5683, (lrx & 0xFF));
    ov5642_write_reg(0x5682, (lrx >> 8) & 0x0F);
    // Y end
    ov5642_write_reg(0x5687, (lry & 0xFF));
    ov5642_write_reg(0x5686, (lry >> 8) & 0x07);
}

void ov5642_set_aec_polygon_ul(__u32 pt)
{
    aec_poly.UL.X = ((pt >> 16) & 0xFFFF);
    aec_poly.UL.Y = (pt & 0xFFFF);
}

void ov5642_set_aec_polygon_lr(__u32 pt)
{
    aec_poly.LR.X = ((pt >> 16) & 0xFFFF);
    aec_poly.LR.Y = (pt & 0xFFFF);
   // Completed combined polygon, set it by reinitilizing sensor mode table
    printk(KERN_INFO "OV5642 0: Setting mode: %d\n", ov5642_data.streamcap.capturemode);
    ov5642_init_mode(ov5642_data.frame_rate, ov5642_data.streamcap.capturemode);
//    ov5642_set_aec_poly();
}
...
static int ioctl_s_parm(struct v4l2_int_device *s, struct v4l2_streamparm *a)
{
	...
	case V4L2_BUF_TYPE_VIDEO_CAPTURE:
		...
		new_frame_rate = get_frame_rate_id(tgt_fps);
		...
		old_frame_rate = get_frame_rate_id(old_fps);
...
static int ioctl_g_ctrl(struct v4l2_int_device *s, struct v4l2_control *vc)
{
	...
	case V4L2_CID_EXPOSURE:
		vc->value = ov5642_get_exposure();
		break;
	case V4L2_CID_AUTOEXPOSURE:
		vc->value = ov5642_get_autoexposure();
		break;
	case V4L2_CID_GAIN:
		vc->value = ov5642_get_gain();
		break;
	case V4L2_CID_AUTOGAIN:
		vc->value = ov5642_get_autogain();
		break;
	default:
		ret = -EINVAL;
	}
...
static int ioctl_s_ctrl(struct v4l2_int_device *s, struct v4l2_control *vc)
{
	...
	case V4L2_CID_GAMMA:
		break;
	case V4L2_CID_AUTOEXPOSURE:
		ov5642_set_autoexposure(vc->value);
		break;
	case V4L2_CID_EXPOSURE:
		ov5642_set_exposure(vc->value);	
		break;
	case V4L2_CID_AUTOGAIN:
		ov5642_set_autogain(vc->value);
		break;
	case V4L2_CID_GAIN:
		ov5642_set_gain(vc->value);
		break;
	case V4L2_CID_HFLIP:
		break;
	case V4L2_CID_VFLIP:
        ...
        case V4L2_CID_AEC_POLYGON_UL:
                ov5642_set_aec_polygon_ul((__u32)vc->value);
                break;
        case V4L2_CID_AEC_POLYGON_LR:
                ov5642_set_aec_polygon_lr((__u32)vc->value);
                break;
...
static int ioctl_dev_init(struct v4l2_int_device *s)
{
	...
	ov5642_data.frame_rate = frame_rate;
	ov5642_data.pix.width = 640;
	ov5642_data.pix.height = 480;
	ov5642_data.streamcap.capturemode = ov5642_mode_VGA_640_480;
			...
			const struct i2c_device_id *id)
{
	...
	printk("OV5642_0: Probing sensor on CSI: %d, clock: %d\n", ov5642_data.csi, ov5642_data.mclk_source);

	ov5642_data.i2c_client = client;
	ov5642_data.pix.pixelformat = V4L2_PIX_FMT_UYVY;
//	ov5642_data.pix.pixelformat = V4L2_PIX_FMT_SBGGR10;
	ov5642_data.pix.width = 640;
	ov5642_data.pix.height = 480;
	...
	ov5642_data.frame_rate = get_frame_rate_id(DEFAULT_FPS);
...
//		plat_data->pwdn(1);
	...
	sprintf(procname, "driver/ov5642_%d", plat_data->csi);
	...
	pr_info("Camera ov5642_0 is found\n");
//	if (plat_data->pwdn)
//		plat_data->pwdn(1);
	return retval;
 ...
 * @return  Error code indicating success or failure
 */
static __init int ov5642_0_init(void)
{
	u8 err;
 ...
 * @return  Error code indicating success or failure
 */
static void __exit ov5642_0_clean(void)
{
	i2c_del_driver(&ov5642_i2c_driver);
}

module_init(ov5642_0_init);
module_exit(ov5642_0_clean);

MODULE_AUTHOR("Freescale Semiconductor, Inc.");
MODULE_DESCRIPTION("OV5642 0 Camera Driver");
MODULE_LICENSE("GPL");
MODULE_VERSION("1.0");
MODULE_ALIAS("CSI");
