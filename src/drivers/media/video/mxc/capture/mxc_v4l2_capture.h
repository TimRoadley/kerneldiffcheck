...
typedef struct _cam_data {
	...
	int green;
	int blue;
	int ae_mode;	/* Auto-exposure mode: 0 - off, 1 - on*/
	int exposure;	/* Manual exposure value */
	int gain;	    /* Manual gain value */
	int ag_mode;	/* Auto-gain mode: 0 - off, 1 - on */
	...
	struct scatterlist sg[2];
        /* Snapshot structure */
        struct mxcv4loverlay_kernel_entry snapshot;
} cam_data;
