...
static void ov5642_set_exposure(unsigned short exposure_in_lines)
{
    ...
    //printk(KERN_INFO "OV5642_1: Set Exposure lines: %d/%d, max: %d\n", exposure_in_lines, explines, max_explines);
...
//		plat_data->pwdn(1);
	...
	pr_info("Camera ov5642_1 is found\n");
//	if (plat_data->pwdn)
//		plat_data->pwdn(1);
	return retval;
 ...
 * @return  Error code indicating success or failure
 */
static __init int ov5642_1_init(void)
{
	u8 err;
 ...
 * @return  Error code indicating success or failure
 */
static void __exit ov5642_1_clean(void)
{
	i2c_del_driver(&ov5642_i2c_driver);
}

module_init(ov5642_1_init);
module_exit(ov5642_1_clean);

MODULE_AUTHOR("Freescale Semiconductor, Inc.");
MODULE_DESCRIPTION("OV5642 1 Camera Driver");
MODULE_LICENSE("GPL");
MODULE_VERSION("1.0");
MODULE_ALIAS("CSI");
